...
public class Cloudlet {
    ...
    /*
     * 用户id，指令长度，文件长度，输出长度，pe数量，cloudlet的id，cloudlet状态 完成时间、开始时间等
     */
     ...
     * byte = program + input data size 程序长度+数据长度
     */
     ...
     * CloudResources. 字段： 提交时间 在资源总运行时间 占用cpu时间 价格 目前完成度 resource的id和name
     */
     ...
     * CloudResource. This Cloudlet length is calculated for 1 Pe only <tt>not</tt>
     * the total length.
     *
     * @param cloudletLength the length or size (in MI) of this Cloudlet to be
     ...
     * @post $none
     */
    public void setCloudletLength(final long cloudletLength) {
        if (cloudletLength > 0) this.cloudletLength = cloudletLength;
    }

    /**
     * Sets the network service level for sending this cloudlet over a network.
     *
     * @param netServiceLevel determines the kind of service this cloudlet receives
     *                        in the network (applicable to selected PacketScheduler
     *                        class only)
    ...
    /**
     * 从提交到运行之间的等待时间 Gets the waiting time of this cloudlet executed on a resource.
     *
    ...
    /**
     * 设置类型和优先权 Sets the classType or priority of this Cloudlet for scheduling on a
     * resource.
     *
     ...
     * For example, this Cloudlet has a length of 500 MI and requires 2 PEs. This
     * means each Pe will execute 500 MI of this Cloudlet.
     *
    ...
    /**
     * 已经执行的长度 Gets the length of this Cloudlet that has been executed so far from
     * the latest CloudResource. This method is useful when trying to move this
    ...
    /**
     * 设置目前已经执行的长度 Sets the length of this Cloudlet that has been executed so far.
    ...
    /**
     * 设置运行cloudlet资源 Sets the resource parameters for which this Cloudlet is going
     * to be executed. <br>
    ...
    /**
     * 设置wall time，和实际执行时间 Sets this Cloudlet's execution parameters. These
     * parameters are set by the CloudResource before departure or sending back to
    ...
    /**
     * 以字符串形式返回cloudlet状态 Gets the status code of this Cloudlet.
     *
    ...
    /**
     * * 某个资源所用的cpu时间 Gets the total execution time of this Cloudlet in a given
     * CloudResource ID.
     *
    ...
    /**
     * &#x67D0;&#x4E2A;&#x8D44;&#x6E90;&#x7684;&#x4EF7;&#x683C; Gets the cost running this Cloudlet in a given CloudResource ID.
     *
     * @param resId a CloudResource entity ID
    ...
    /**
     * 给定的resource已经执行的cloudlet的长度 Gets the length of this Cloudlet that has been
     * executed so far in a given CloudResource ID. This method is useful when
     * trying to move this Cloudlet into different CloudResources or to cancel it.
     *
     * @param resId a CloudResource entity ID
     * @return the length of a partially executed Cloudlet or the full Cloudlet
     ...
     */
    public void addRequiredFile(final String fileName) {
    ...
    public boolean deleteRequiredFile(final String filename) {
        boolean result = false;
        if (getRequiredFiles() == null) return false;
    ...
    public boolean requiresFiles() {
		return getRequiredFiles() != null && getRequiredFiles().size() > 0;
    }
