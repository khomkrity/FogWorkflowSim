...
public class Task extends Cloudlet {
     ...
     */
    private Map<Integer, Double> transferCosts;
    ...
    public Task(final int taskId, final long taskLength) {
        ...
        this.transferCosts = new HashMap<>();
        sendingLatency = 0;
        receivingLatency = 0;
     ...
     *
     * @param transferCosts a hash map containing all parent's task delay <Integer, Double>
     */
    public void setTransferCosts(Map<Integer, Double> transferCosts) {
     ...
     */
    public Map<Integer, Double> getTransferCosts() {
...
//	}
    ...
    public void setSendingLatency(double sendingLatency) {
    ...
    public void setReceivingLatency(double receivingLatency) {
